...
const GuidedCameraView = ({ onCameraClose, onScreen = false, terminalLogs = false, onVideoSave, language = "english", }) => {
    ...
    return (_jsxs(View, { style: styles.container, children: [_jsx(CameraView, { ref: cameraRef, style: styles.camera, facing: facing, onCameraReady: onCameraReady, mode: cameraMode }), _jsxs(View, { style: StyleSheet.absoluteFillObject, children: [renderAngleIndicator(), renderBalanceIndicator(), renderCompassIndicator()] }), isRecording && (_jsxs(View, { style: styles.recordingIndicator, children: [_jsx(View, { style: styles.recordingDot }), _jsxs(Text, { style: [styles.recordingText, getTextStyle("bold")], children: [translations.recording, " ", formatRecordingTime(recordingDuration)] })] })), !isCameraReady && (_jsx(View, { style: styles.cameraNotReady, children: _jsx(Text, { style: [styles.cameraNotReadyText, getTextStyle("bold")], children: translations.preparing }) })), _jsxs(View, { style: [styles.topBar, isRTL && styles.topBarRTL], children: [_jsxs(View, { style: styles.statusItem, children: [_jsx(Text, { style: [styles.statusLabel, getTextStyle("bold")], children: translations.pitch }), _jsx(Text, { style: [
                                    ...
                                    getTextStyle("bold"),
                                ], children: getQualityTranslation(lightingMetrics.quality) }), _jsx(Text, { style: [styles.statusValue, getTextStyle("bold")], children: Math.round(lightingMetrics.meanLuminance) })] })] }), _jsxs(View, { style: styles.guidanceContainer, children: [speedMetrics.isMoving &&
